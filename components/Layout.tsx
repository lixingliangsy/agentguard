    ...
    <header className="bg-white shadow-sm border-b">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <nav className="flex gap-4 text-sm">
          ...
          <a href="/use-cases" className="text-gray-600 hover:text-brand">Use cases</a>
          <a href="/integrations" className="text-gray-600 hover:text-brand">Integrations</a>
          <a href="/security" className="text-gray-600 hover:text-brand">Security</a>
          <a href="/blog" className="text-gray-600 hover:text-brand">Blog</a>
          <a href="/#pricing" className="text-gray-600 hover:text-brand">Pricing</a>
        </nav>
      </div>
    </header>
