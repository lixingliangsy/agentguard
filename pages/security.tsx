    ...
    <Layout>
      ...
      <div className="max-w-3xl">
        ...
        <p className="text-lg text-slate-600 mb-10">
          AgentAegis processes the inputs you submit for analysis. This page states, plainly, what we handle and what we do not claim.
        </p>

        <Sec title="What we handle">
          <p>agent system prompts, tool lists, and risk-appetite selections for guardrail recommendations.</p>
        </Sec>
        ...
        <div className="rounded-2xl border border-amber-200 bg-amber-50 p-5 mb-10 text-sm text-amber-900">
          <strong>Honesty rule:</strong> AgentAegis suggests filters and ratings; it does not guarantee blocked exfiltration, 100% safe tool use, or that you will never miss a dangerous action. We do <strong>not</strong> claim guarantee / 100% / never miss.
        </div>

        <Sec title="Our compliance posture">
          <ul className="list-disc pl-5 space-y-1">
            <li>AgentAegis is <strong>decision-support</strong>, not a law firm, clinic, or certified auditor.</li>
        ...
        <p className="text-xs text-slate-400 mt-8">
          refs: OWASP Top 10 for AI Agents · EU AI Act (Reg. 2024/1689) · OWASP LLM01
        </p>
      </div>
    </Layout>
  )
