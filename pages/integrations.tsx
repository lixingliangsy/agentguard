...
const rows = [
  { title: "copy as Markdown/JSON text", body: "Export guardrail reports via /api/runs." },
  { title: "API", body: "Pull ratings into agent platforms." },
  { title: "Shared rulesets (Enterprise)", body: "Team-wide guardrail packs." },
  { title: "BYOK", body: "Keys stay server-side." },
]
    ...
    <Layout>
      ...
      <div className="max-w-4xl">
        ...
        <div className="rounded-2xl border border-amber-200 bg-amber-50 p-5 mt-6 text-sm text-amber-900">
          <strong>Honesty note:</strong> Runtime enforcement hooks are product-side; we generate reports, not a guarantee of enforcement.
        </div>
      </div>
    </Layout>
  )
